...
The domain is decomposed based on calibrated particle weights.
\begin{table}
\resizebox{\textwidth}{!}{  
...
\begin{figure}
\flushleft
\includegraphics[width=0.475\textwidth]{t=120_msfrc}
\hfill
\includegraphics[width=0.475\textwidth]{t=120_involved}
\end{figure}
\end{frame}
...
\includemedia[
  ...
  flashvars={source=mssfrc_sml400.mp4 &loop=false}
  ]{}{VPlayer.swf}
\end{minipage}
\hfill
\begin{minipage}{.32\linewidth} 
  ...
  flashvars={source=cut_view_mssfrc_sml400.mp4 &loop=false}]
  {}{VPlayer.swf}
\end{minipage}
\hfill  
\begin{minipage}{.32\linewidth} 
  ...
  flashvars={source=cut_view_Involved_sml400.mp4 &loop=false}]
  {}{VPlayer.swf}
\end{minipage}
%  
  \mediabutton[
